    ...
    return (
        <>
            ...
            <div className='home mx-[111px]'>
                <ScrollToTop />
                <img src="/Images/Home/wave.png" className='absolute right-0 top-[4rem] h-[450px] w-[100%] -z-10' />
                <img src="/Images/Home/logout.png" onClick={handleSubmit} className="absolute right-6 top-[4.5rem] cursor-pointer " />
