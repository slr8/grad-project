...
const ITLabDevices = () => {
    return (
        <div>
            ...
            <div className='grid grid-cols-3 place-items-center mx-56 mt-10 gap-5'>
                <DevicesGreenBox
            ...
            <div className='grid grid-cols-3 place-items-center mx-56 mt-10 gap-5 mb-8'>
                <DevicesGreenBox
                    img={"/Images/ITDevices/Group.png"}
                    name={"AC"}
                />
