...
const AddOnHover = () => {
    return (
        <div className='bg-gray-300 w-full h-full rounded-r-lg border-l-8 border-solid border-blue-800 flex justify-center items-center opacity-0 transition-all delay-100 hover:opacity-100'>
